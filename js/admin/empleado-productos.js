document.addEventListener("DOMContentLoaded", () => {
    ...
    function ajustarInterfazEmpleado() {
        // 1. Ocultar el botón principal de 'Agregar'
        const btnAgregar = document.getElementById("btn-agregar-producto");
        if (btnAgregar) {
    ...
    document.querySelectorAll("#productos-tbody .btn-delete").forEach(btn => {
        // Asumiendo que el botón de eliminar tiene la clase 'btn-delete'
